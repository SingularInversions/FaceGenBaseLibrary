...
$(ODIRLibFgBase)FgMatrixEigen.o: $(SDIRLibFgBase)FgMatrixEigen.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgMatrixEigen.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgMatrixEigen.cpp
