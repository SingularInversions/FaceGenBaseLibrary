...
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_binary_iarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_binary_iarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_binary_iarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_binary_iarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_binary_oarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_binary_oarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_binary_oarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_binary_oarchive.cpp
...
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_iarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_iarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_iarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_iarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_oarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_oarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_oarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_oarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_wiarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_wiarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_wiarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_wiarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_woarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_woarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_text_woarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_text_woarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_iarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_iarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_iarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_iarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_oarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_oarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_oarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_oarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_wiarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_wiarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_wiarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_wiarchive.cpp
$(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_woarchive.o: $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_woarchive.cpp $(INCSLibTpBoost)
	$(CXX) -o $(ODIRLibTpBoost)libs_serialization_src_polymorphic_xml_woarchive.o -c $(CXXFLAGS) $(FLAGSLibTpBoost) $(SDIRLibTpBoost)libs/serialization/src/polymorphic_xml_woarchive.cpp
...
FLAGSLibFgBase =  -Wall -Wextra -DBOOST_ALL_NO_LIB -DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE -ILibFgBase/src/ -isystem LibTpEigen/ -isystem LibTpStb/stb/ -isystem LibTpBoost/boost_1_69_0/
SDIRLibFgBase = LibFgBase/src/
ODIRLibFgBase = $(BUILDIR)LibFgBase/
$(shell mkdir -p $(ODIRLibFgBase))
INCSLibFgBase := $(wildcard LibFgBase/src/*.hpp) $(wildcard LibTpEigen/Eigen/*.hpp) $(wildcard LibTpStb/stb/*.hpp) $(wildcard LibTpBoost/boost_1_69_0/boost/*.hpp) 
...
FLAGSfgbl =  -Wall -Wextra -DBOOST_ALL_NO_LIB -DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE -ILibFgBase/src/ -isystem LibTpBoost/boost_1_69_0/
SDIRfgbl = fgbl/
ODIRfgbl = $(BUILDIR)fgbl/
$(shell mkdir -p $(ODIRfgbl))
INCSfgbl := $(wildcard LibFgBase/src/*.hpp) $(wildcard LibTpBoost/boost_1_69_0/boost/*.hpp) 
