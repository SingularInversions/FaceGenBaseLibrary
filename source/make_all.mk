...
$(BUILDIR)LibFgBase.a: $(ODIRLibFgBase)Fg3dCamera.o $(ODIRLibFgBase)Fg3dDisplay.o $(ODIRLibFgBase)Fg3dMesh.o $(ODIRLibFgBase)Fg3dMesh3ds.o $(ODIRLibFgBase)Fg3dMeshDae.o $(ODIRLibFgBase)Fg3dMeshFbx.o $(ODIRLibFgBase)Fg3dMeshFgmesh.o $(ODIRLibFgBase)Fg3dMeshIo.o $(ODIRLibFgBase)Fg3dMeshLegacy.o $(ODIRLibFgBase)Fg3dMeshLwo.o $(ODIRLibFgBase)Fg3dMeshMa.o $(ODIRLibFgBase)Fg3dMeshObj.o $(ODIRLibFgBase)Fg3dMeshOps.o $(ODIRLibFgBase)Fg3dMeshPly.o $(ODIRLibFgBase)Fg3dMeshStl.o $(ODIRLibFgBase)Fg3dMeshTri.o $(ODIRLibFgBase)Fg3dMeshVrml.o $(ODIRLibFgBase)Fg3dMeshXsi.o $(ODIRLibFgBase)Fg3dNormals.o $(ODIRLibFgBase)Fg3dPose.o $(ODIRLibFgBase)Fg3dRayCaster.o $(ODIRLibFgBase)Fg3dSurface.o $(ODIRLibFgBase)Fg3dTest.o $(ODIRLibFgBase)Fg3dTopology.o $(ODIRLibFgBase)FgAlgs.o $(ODIRLibFgBase)FgApproxFunc.o $(ODIRLibFgBase)FgBuild.o $(ODIRLibFgBase)FgCl.o $(ODIRLibFgBase)FgCluster.o $(ODIRLibFgBase)FgCmdBase.o $(ODIRLibFgBase)FgCmdImgops.o $(ODIRLibFgBase)FgCmdMeshops.o $(ODIRLibFgBase)FgCmdMorph.o $(ODIRLibFgBase)FgCmdNcServer.o $(ODIRLibFgBase)FgCmdRender.o $(ODIRLibFgBase)FgCmdTestmCpp.o $(ODIRLibFgBase)FgCmdView.o $(ODIRLibFgBase)FgCommand.o $(ODIRLibFgBase)FgCons.o $(ODIRLibFgBase)FgConsMakefiles.o $(ODIRLibFgBase)FgConsVisualStudio201x.o $(ODIRLibFgBase)FgDepGraph.o $(ODIRLibFgBase)FgDepGraphSt.o $(ODIRLibFgBase)FgDepGraphTest.o $(ODIRLibFgBase)FgDepGraphUtils.o $(ODIRLibFgBase)FgDiagnostics.o $(ODIRLibFgBase)FgDraw.o $(ODIRLibFgBase)FgException.o $(ODIRLibFgBase)FgExceptionTest.o $(ODIRLibFgBase)FgFileSystem.o $(ODIRLibFgBase)FgFileSystemTest.o $(ODIRLibFgBase)FgFileUtils.o $(ODIRLibFgBase)FgGaTest.o $(ODIRLibFgBase)FgGeometry.o $(ODIRLibFgBase)FgGeometryTest.o $(ODIRLibFgBase)FgGridTriangles.o $(ODIRLibFgBase)FgGuiApi.o $(ODIRLibFgBase)FgGuiApi3d.o $(ODIRLibFgBase)FgGuiApiBase.o $(ODIRLibFgBase)FgGuiApiButton.o $(ODIRLibFgBase)FgGuiApiCheckbox.o $(ODIRLibFgBase)FgGuiApiDialogs.o $(ODIRLibFgBase)FgGuiApiImage.o $(ODIRLibFgBase)FgGuiApiRadio.o $(ODIRLibFgBase)FgGuiApiSlider.o $(ODIRLibFgBase)FgGuiApiSplit.o $(ODIRLibFgBase)FgGuiApiText.o $(ODIRLibFgBase)FgHex.o $(ODIRLibFgBase)FgHistogram.o $(ODIRLibFgBase)FgImage.o $(ODIRLibFgBase)FgImageIo.o $(ODIRLibFgBase)FgImageIoStb.o $(ODIRLibFgBase)FgImageTest.o $(ODIRLibFgBase)FgImgDisplay.o $(ODIRLibFgBase)FgImgJpeg.o $(ODIRLibFgBase)FgKdTree.o $(ODIRLibFgBase)FgLazy.o $(ODIRLibFgBase)FgLighting.o $(ODIRLibFgBase)FgMain.o $(ODIRLibFgBase)FgMath.o $(ODIRLibFgBase)FgMatrixC.o $(ODIRLibFgBase)FgMatrixSolver.o $(ODIRLibFgBase)FgMatrixSolverEigen.o $(ODIRLibFgBase)FgMatrixV.o $(ODIRLibFgBase)FgMetaFormat.o $(ODIRLibFgBase)FgNc.o $(ODIRLibFgBase)FgOut.o $(ODIRLibFgBase)FgParse.o $(ODIRLibFgBase)FgPath.o $(ODIRLibFgBase)FgPlatform.o $(ODIRLibFgBase)FgQuaternion.o $(ODIRLibFgBase)FgRandom.o $(ODIRLibFgBase)FgRayCaster.o $(ODIRLibFgBase)FgSampler.o $(ODIRLibFgBase)FgSharedPtrTest.o $(ODIRLibFgBase)FgSimilarity.o $(ODIRLibFgBase)FgSoftRender.o $(ODIRLibFgBase)FgStdio.o $(ODIRLibFgBase)FgStdStream.o $(ODIRLibFgBase)FgStdString.o $(ODIRLibFgBase)FgStdVectorTest.o $(ODIRLibFgBase)FgString.o $(ODIRLibFgBase)FgStringTest.o $(ODIRLibFgBase)FgSyntax.o $(ODIRLibFgBase)FgTcpTest.o $(ODIRLibFgBase)FgTensorC.o $(ODIRLibFgBase)FgTestUtils.o $(ODIRLibFgBase)FgThread.o $(ODIRLibFgBase)FgTime.o $(ODIRLibFgBase)FgVariant.o $(ODIRLibFgBase)FgViz.o $(ODIRLibFgBase)jpeg_mem_dest.o $(ODIRLibFgBase)jpeg_mem_src.o $(ODIRLibFgBase)portable_binary_iarchive.o $(ODIRLibFgBase)portable_binary_oarchive.o $(ODIRLibFgBase)stdafx.o $(ODIRLibFgBase)nix_Fg3dOpenGLImpNix.o $(ODIRLibFgBase)nix_FgClNix.o $(ODIRLibFgBase)nix_FgClusterNix.o $(ODIRLibFgBase)nix_FgConioNix.o $(ODIRLibFgBase)nix_FgFileSystemNix.o $(ODIRLibFgBase)nix_FgGaNix.o $(ODIRLibFgBase)nix_FgGuiNix.o $(ODIRLibFgBase)nix_FgSystemInfoNix.o $(ODIRLibFgBase)nix_FgTcpNix.o $(ODIRLibFgBase)nix_FgThreadNix.o $(ODIRLibFgBase)nix_FgTimeNix.o $(ODIRLibFgBase)nix_FgWinSpecificNix.o 
...
$(ODIRLibFgBase)Fg3dNormals.o: $(SDIRLibFgBase)Fg3dNormals.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)Fg3dNormals.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)Fg3dNormals.cpp
$(ODIRLibFgBase)Fg3dPose.o: $(SDIRLibFgBase)Fg3dPose.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)Fg3dPose.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)Fg3dPose.cpp
$(ODIRLibFgBase)Fg3dRayCaster.o: $(SDIRLibFgBase)Fg3dRayCaster.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)Fg3dRayCaster.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)Fg3dRayCaster.cpp
...
$(ODIRLibFgBase)Fg3dTopology.o: $(SDIRLibFgBase)Fg3dTopology.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)Fg3dTopology.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)Fg3dTopology.cpp
$(ODIRLibFgBase)FgAlgs.o: $(SDIRLibFgBase)FgAlgs.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgAlgs.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgAlgs.cpp
...
$(ODIRLibFgBase)FgCmdImgops.o: $(SDIRLibFgBase)FgCmdImgops.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgCmdImgops.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgCmdImgops.cpp
$(ODIRLibFgBase)FgCmdMeshops.o: $(SDIRLibFgBase)FgCmdMeshops.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgCmdMeshops.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgCmdMeshops.cpp
...
$(ODIRLibFgBase)FgCmdNcServer.o: $(SDIRLibFgBase)FgCmdNcServer.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgCmdNcServer.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgCmdNcServer.cpp
...
$(ODIRLibFgBase)FgCons.o: $(SDIRLibFgBase)FgCons.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgCons.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgCons.cpp
$(ODIRLibFgBase)FgConsMakefiles.o: $(SDIRLibFgBase)FgConsMakefiles.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgConsMakefiles.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgConsMakefiles.cpp
$(ODIRLibFgBase)FgConsVisualStudio201x.o: $(SDIRLibFgBase)FgConsVisualStudio201x.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgConsVisualStudio201x.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgConsVisualStudio201x.cpp
$(ODIRLibFgBase)FgDepGraph.o: $(SDIRLibFgBase)FgDepGraph.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgDepGraph.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgDepGraph.cpp
$(ODIRLibFgBase)FgDepGraphSt.o: $(SDIRLibFgBase)FgDepGraphSt.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgDepGraphSt.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgDepGraphSt.cpp
$(ODIRLibFgBase)FgDepGraphTest.o: $(SDIRLibFgBase)FgDepGraphTest.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgDepGraphTest.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgDepGraphTest.cpp
$(ODIRLibFgBase)FgDepGraphUtils.o: $(SDIRLibFgBase)FgDepGraphUtils.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgDepGraphUtils.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgDepGraphUtils.cpp
...
$(ODIRLibFgBase)FgDraw.o: $(SDIRLibFgBase)FgDraw.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgDraw.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgDraw.cpp
...
$(ODIRLibFgBase)FgGaTest.o: $(SDIRLibFgBase)FgGaTest.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgGaTest.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgGaTest.cpp
...
$(ODIRLibFgBase)FgGeometryTest.o: $(SDIRLibFgBase)FgGeometryTest.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgGeometryTest.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgGeometryTest.cpp
...
$(ODIRLibFgBase)FgLazy.o: $(SDIRLibFgBase)FgLazy.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgLazy.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgLazy.cpp
...
$(ODIRLibFgBase)FgSharedPtrTest.o: $(SDIRLibFgBase)FgSharedPtrTest.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgSharedPtrTest.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgSharedPtrTest.cpp
...
$(ODIRLibFgBase)FgStdVectorTest.o: $(SDIRLibFgBase)FgStdVectorTest.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgStdVectorTest.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgStdVectorTest.cpp
...
$(ODIRLibFgBase)FgTensorC.o: $(SDIRLibFgBase)FgTensorC.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgTensorC.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgTensorC.cpp
...
$(ODIRLibFgBase)FgThread.o: $(SDIRLibFgBase)FgThread.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgThread.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgThread.cpp
...
$(ODIRLibFgBase)FgVariant.o: $(SDIRLibFgBase)FgVariant.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgVariant.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgVariant.cpp
$(ODIRLibFgBase)FgViz.o: $(SDIRLibFgBase)FgViz.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)FgViz.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)FgViz.cpp
...
$(ODIRLibFgBase)nix_Fg3dOpenGLImpNix.o: $(SDIRLibFgBase)nix/Fg3dOpenGLImpNix.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)nix_Fg3dOpenGLImpNix.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)nix/Fg3dOpenGLImpNix.cpp
$(ODIRLibFgBase)nix_FgClNix.o: $(SDIRLibFgBase)nix/FgClNix.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)nix_FgClNix.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)nix/FgClNix.cpp
...
$(ODIRLibFgBase)nix_FgGaNix.o: $(SDIRLibFgBase)nix/FgGaNix.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)nix_FgGaNix.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)nix/FgGaNix.cpp
...
$(ODIRLibFgBase)nix_FgThreadNix.o: $(SDIRLibFgBase)nix/FgThreadNix.cpp $(INCSLibFgBase)
	$(CXX) -o $(ODIRLibFgBase)nix_FgThreadNix.o -c $(CXXFLAGS) $(FLAGSLibFgBase) $(SDIRLibFgBase)nix/FgThreadNix.cpp
...
FLAGSfgbl =  -Wall -Wextra -DBOOST_ALL_NO_LIB -DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE -ILibFgBase/src/ -ILibTpBoost/boost_1_67_0/
SDIRfgbl = fgbl/
